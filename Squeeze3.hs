...
insert_col g (mig,mgg) = (mig',mgg') where
...
delete_col g (mig, mgg) = (mig', mgg') where
...
instantiate_col (bs) (mig,mgg) = (mig', mgg') where
...
instantiate' [] xs = xs
instantiate' (h:t) xs = instantiate' t xs' where
...
instantiate_rule b ((ll,lr),(rl,rr)) = ((ll',lr'),(rl',rr')) where
  [ll', lr', rl', rr'] = map (instantiate' b) [ll, lr, rl, rr]

instantiate_rule' :: Subst -> Rule' -> Rule'
instantiate_rule' b (Rule l lg r s) = Rule l' lg' r' s where
...
rewrite  (l@(ll,lr),r@(rl,rr)) xss = xss' where
...
rewrite' :: Rule' -> [Column] -> [Column]
rewrite'  rule@(Rule l lg r b4r) xss = xss' where
...
rewrite's  rule@(Rule l lg r b4r) xss = xss' where
  rm_lhs = zipWith (\x y -> delete_col_m x y) l xss
  len_lhs = length rm_lhs
  rhs = squee_of_gatess r
...
hrules' = [
  ...
  Rule [[H (-2)], [CX (-1) (-2)], [I (-2), H (-1)], [CCZ (-3) (-4) (-1)]] []
       [[H (-1)], [CX (-2) (-1)], [H (-2)], [CCZ (-3) (-4) (-1)]] 3,  
  Rule [[H (-2)], [CX (-1) (-2)], [I (-2), H (-1)], [CCZ (-3) (-1) (-4)]] []
       [[H (-1)], [CX (-2) (-1)], [H (-2)], [CCZ (-3) (-1) (-4)]] 3,  
  Rule [[H (-2)], [CX (-1) (-2)], [I (-2), H (-1)], [CCZ (-1) (-4) (-3)]] []
       [[H (-1)], [CX (-2) (-1)], [H (-2)], [CCZ (-1) (-4) (-3)]] 3,  

  Rule [[H (-1)],[CX (-1) (-2)]] []
       [[CZ (-1) (-2)],[H (-1)]] 1,

  Rule [[H (-1)], [S (-1)], [H (-1)]] []
       [[Z (-1)], [S (-1)], [X (-1)], [H (-1)], [S (-1)]] 0
  ]
...
cxccx_rules' = [
  -- similarly, when involving CCX, we need 2 or more repeated rules
  -- considering the symmetry of CCX.
  Rule [[CX (-1) (-2)], [CCX (-2) (-3) (-4)]]  []
       [[CCX (-2) (-3) (-4)], [CCX (-1) (-3) (-4)], [CX (-1) (-2)]] 1,
  
  Rule [[CX (-1) (-2)], [CCX (-1) (-3) (-4)]]  []
       [[CCX (-1) (-3) (-4)], [CX (-1) (-2)]] 1
...
adjust_CZ_CCZ (CCZ i j k) = CCZ i' j' k' where
  xs = sort [i,j,k]
  i' = xs !! 0
  j' = xs !! 1
  k' = xs !! 2  
...
show_rule :: Rule -> [[Gate]]
show_rule ((ll,lr),(rl,rr)) = ll' ++ [[M 0]] ++ rr' where
